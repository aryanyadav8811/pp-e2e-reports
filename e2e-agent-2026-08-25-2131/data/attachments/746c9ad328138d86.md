...
- Name: packs/pack-detail.spec.ts >> Pack detail (DFS-2114) >> View Odds opens the Pack Odds modal (when the pack has odds)
- Location: tests/packs/pack-detail.spec.ts:47:5
