...
- Name: packs/lobby.spec.ts >> Packs lobby (DFS-2114) >> Pending Packs row lists 'Open Pack' actions when the user owns open rounds
- Location: tests/packs/lobby.spec.ts:64:3
