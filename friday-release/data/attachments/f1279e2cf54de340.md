...
- Name: auth/login.spec.ts >> Login - Invalid Credentials >> cannot login with unknown username
- Location: tests/auth/login.spec.ts:138:3
    ...
    - generic [ref=e3]:
      ...
      - main [ref=e14]:
        - generic [ref=e19]:
          ...
          - generic [ref=e21]:
            - textbox "Username/E-mail" [ref=e24]: nouser@example.com
            - generic [ref=e27]:
