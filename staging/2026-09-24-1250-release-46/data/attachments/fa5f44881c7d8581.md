...
Call log:
  - waiting for locator('article[data-testid^="partner-reward-card-"]').first() to be visible
    31 × locator resolved to hidden <article data-state="available" data-testid="partner-reward-card-clash5" class="flex flex-col w-full rounded-2xl border border-borderPrimary shadow-sm p-5 gap-4 cursor-pointer">…</article>
