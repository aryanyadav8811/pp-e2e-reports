...
Call log:
  ...
  - waiting for locator('#hubspotForm iframe').first()
    3 × locator resolved to <iframe width="100%" title="Form 1" scrolling="no" id="hs-form-iframe-1" class="hs-form-iframe"></iframe>
      - unexpected value "hidden"
    30 × locator resolved to <iframe height="0" width="100%" title="Form 1" scrolling="no" id="hs-form-iframe-1" class="hs-form-iframe"></iframe>
       - unexpected value "hidden"
