...
- Name: menu/account-dropdown-desktop.spec.ts >> Menu - Desktop Account Dropdown >> Dropdown shows the Deposit CTA and the Account/Rewards/Support groups
- Location: tests/menu/account-dropdown-desktop.spec.ts:24:3
