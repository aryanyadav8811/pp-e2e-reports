...
- Name: signup/validation.spec.ts >> Signup - Validation (route mock) >> email format and uniqueness helper updates
- Location: tests/signup/validation.spec.ts:15:5
...
Call log:
  ...
  - attempting click action
    ...
    - retrying click action
      - waiting 100ms
    350 × waiting for element to be visible, enabled and stable
        - element is not enabled
      - retrying click action
        - waiting 500ms
