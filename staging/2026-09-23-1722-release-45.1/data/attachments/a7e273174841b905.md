...
Call log:
  - waiting for locator('article[data-testid^="partner-reward-card-"]').first() to be visible
    14 × locator resolved to hidden <article data-state="available" data-testid="partner-reward-card-clash5" class="flex flex-col w-full rounded-2xl border border-borderPrimary shadow-sm p-5 gap-4 cursor-pointer">…</article>
      ...
      - contentinfo [ref=e70]:
        - navigation [ref=e71]:
          - list [ref=e72]:
            ...
            - listitem [ref=e78]:
              - button "Entries 194" [ref=e79] [cursor=pointer]:
                - generic [ref=e80]:
                  - img [ref=e81]
