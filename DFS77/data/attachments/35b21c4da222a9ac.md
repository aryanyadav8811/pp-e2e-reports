...
- Name: navigation/footer-nav.spec.ts >> Bottom nav — tab routing & active indicator (DFS-1998) >> Only one tab is active at a time and Home restores
- Location: tests/navigation/footer-nav.spec.ts:105:5
